...
На рисунках 2-5 представлены частные примеры результатов вычислений в режиме "Расчёт одного луча".

![image](https://user-images.githubusercontent.com/45719826/169469817-f9c6a540-c9e9-4f54-ae21-3bc2a33784e3.png)
Рисунок 2 – Пример хода луча, не прошедшего фокон
![image](https://user-images.githubusercontent.com/45719826/169471437-9f6316af-5d58-4c65-95b3-8b21d85d8100.png)
Рисунок 3 – Пример хода луча, не попадающего на приёмник
![image](https://user-images.githubusercontent.com/45719826/169471557-de3bf929-15a5-4f9a-8e56-3a256fb9c0a8.png)
Рисунок 4 – Пример хода луча, попадающего на приёмник под слишком большим углом
![image](https://user-images.githubusercontent.com/45719826/169472213-af8c8538-a84f-4c5f-91de-0f001af05d18.png)
Рисунок 5 – Пример хода прошедшего и принятого луча
...
На рисунке 6 представлен пример графического представления результатов вычислений в режиме "Параллельный пучок".

![image](https://user-images.githubusercontent.com/45719826/169468577-7a29ff25-7391-414b-8377-f23896a0514b.png)

Рисунок 6 – Пример графического представления результатов вычислений в режиме "Параллельный пучок"
...
На рисунке 7 представлен пример графического представления результатов вычислений в режиме "Выход параллельного пучка". Цвет точки кодирует угол между лучом и осью Z. Фиолетовый цвет обозначает угол 0°, красный – 90°, а прочие цвета спектра соответствуют промежуточным значениям. Для упрощения визуального восприятия в таблице 1 представлены цвета, соответствующие некоторым опорным значениям углов. По результатам вычислений в статусной строке выводится сообщение о среднем значении выходного угла.

![image](https://user-images.githubusercontent.com/45719826/169468912-fafc544d-48ae-4080-84f8-d3e16c4f33db.png)

Рисунок 7 – Пример графического представления результатов вычислений в режиме "Выход параллельного пучка"
...
На рисунке 8 представлен графического представления пример результатов вычислений в режиме "Выход параллельного пучка". 

![image](https://user-images.githubusercontent.com/45719826/169472875-8574e08d-a4f8-483f-b9d4-ec255445ea41.png)
Рисунок 8 – Пример графического представления результатов вычислений в режиме "Расходящийся пучок"
...
<h3>Меню «Вид»</h3>
С помощью меню «Вид» реализованы следующие возможности регулировки интерфейса программы:

1. Переключение между светлой и тёмной темами. Первая более подходит для представления результатов в отчётах, тогда как вторая может быть удобнее для пользователя, особенно в условиях долгой работы с программой.
2. Увеличение шрифта в элементах интерфейса для удобства чтения.
